            ...
            <div class="widget-content p-0">
                <div class="widget-content-wrapper">
                    <div class="widget-content-left">
                        <div class="btn-group">
                            <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                class="p-0 btn">
                                <img width="42" class="rounded-circle" src="./img/stats.Recurso 1-100.jpg"
                                    alt="">
                                                ...
                                                <div class="widget-content-wrapper">
                                                    <div class="widget-content-left mr-3">
                                                        <img width="42" class="rounded-circle"
                                                            src="./img/stats.Recurso 1-100.jpg" alt="">
                                                    </div>
                                                    <div class="widget-content-left">
                                                        <div class="widget-heading">Administrador</div>
                    ...
                    <div class="widget-content-left  ml-3 header-user-info">
                        ...
                        <div class="widget-subheading"> Administrador BiosApps </div>
                    </div>
...
<div class="app-sidebar sidebar-shadow">
            ...
            <div class="scrollbar-sidebar ps">
                        ...
                        <li class="">
                            ...
                            <ul class="mm-collapse" style="height: 7.04px;">
                                <li class="">
                                    ...
                                    <ul class="mm-collapse">
                                        <li>
                                            <a href="elements-buttons-standard.html" class="">
                ...
                <div class="ps__rail-y" style="top: 0px; height: 896px; right: 0px;">
